...
PRODUCT_COPY_FILES += \
    vendor/google/pixelcommon/etc/permissions/privapp-permissions-pixel.xml:product/etc/permissions/privapp-permissions-pixel.xml \
    ...
    vendor/google/crosshatch/proprietary/lib/libseccam.so:system/lib/libseccam.so \
    vendor/google/crosshatch/proprietary/lib/libsmcinvokecred.so:system/lib/libsmcinvokecred.so \
    vendor/google/crosshatch/proprietary/lib/libsns_fastRPC_util.so:system/lib/libsns_fastRPC_util.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/libseccam.so:system/lib64/libseccam.so \
    vendor/google/crosshatch/proprietary/lib64/libsmcinvokecred.so:system/lib64/libsmcinvokecred.so \
    vendor/google/crosshatch/proprietary/lib64/libsns_fastRPC_util.so:system/lib64/libsns_fastRPC_util.so \
